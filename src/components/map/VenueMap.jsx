...
import { venueZonesData as zonesData } from '../../data/mockData';
...
const VenueMap = ({ setCurrentTab }) => {
  ...
  const activeZoneData = useMemo(() => zonesData.find((z) => z.id === activeZone), [activeZone]);
    ...
    <div className={styles.mapContainer}>
      ...
      <div className={styles.mapArea}>
        <svg viewBox="0 0 300 300" className={styles.svgMap}>
          ...
          />
          <text x="150" y="155" className={styles.zoneText}>
            Main Field
          </text>
          ...
          />
          <text x="150" y="48" className={styles.zoneText}>
            North Gate
          </text>
          ...
          />
          <text x="150" y="255" className={styles.zoneText}>
            South Gate
          </text>
          ...
          />
          <text x="35" y="155" className={styles.zoneText}>
            Food
          </text>
          ...
          />
          <text x="265" y="155" className={styles.zoneText}>
            Merch
          </text>
        </svg>
